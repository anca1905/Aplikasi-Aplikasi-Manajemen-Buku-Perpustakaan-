        ...
        <nav class="main-header navbar navbar-expand navbar-success navbar-dark">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ route('officerdashboard') }}" class="nav-link">Home</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ route('officerdashboard') }}" class="nav-link">Setting</a>
                </li>
            </ul>
        ...
        <aside class="main-sidebar sidebar-light-success elevation-4">
            ...
            <a href="#" class="brand-link">
                <img src="{{ asset('img/logo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
                <span class="brand-text font-weight-light"><b>SI PERPUS</b></span>
            </a>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        @endif
                        <li class="nav-item">
                            <a href="{{ route('officersirkulasi.index') }}"
                                class="nav-link {{ request()->is('officer/sirkulasi') ? 'active' : '' }}">
